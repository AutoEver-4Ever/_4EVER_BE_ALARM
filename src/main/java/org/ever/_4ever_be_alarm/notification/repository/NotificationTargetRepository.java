...
import org.ever._4ever_be_alarm.common.entity.NotificationTarget;
...
public interface NotificationTargetRepository extends JpaRepository<NotificationTarget, Long> {
    ...
    Page<NotificationTarget> findByUserId(@Param("userId") Long userId, Pageable pageable);
    ...
    @Query("SELECT nt FROM NotificationTarget nt " +
        ...
        "ORDER BY nt.createdAt DESC")
    List<NotificationTarget> findUnreadByUserId(@Param("userId") Long userId);
    ...
    @Query("SELECT nt FROM NotificationTarget nt " +
        ...
        "ORDER BY nt.createdAt DESC")
    List<NotificationTarget> findByNotificationId(@Param("notificationId") Long notificationId);
    ...
    int markAsReadByUserIdAndTargetId(@Param("userId") Long userId,
    ...
    @Query("SELECT nt FROM NotificationTarget nt " +
        ...
        "ORDER BY nt.createdAt DESC")
    List<NotificationTarget> findByStatusId(@Param("statusId") Long statusId);
